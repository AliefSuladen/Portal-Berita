    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="nama_berita" value="<?=$berita->nama_berita?>" placeholder="Nama Berita" required>
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="iframe" placeholder="Video Youtube"  value="<?=$berita->iframe?>" required>
            </div>
