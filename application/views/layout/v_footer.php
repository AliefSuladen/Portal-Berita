<footer>
    ...
    <!-- inject:js -->
    <script src="<?= base_url(); ?>template/front-end/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="<?= base_url(); ?>template/front-end/assets/vendors/aos/dist/aos.js/aos.js"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="<?= base_url(); ?>template/front-end//assets/js/demo.js"></script>
    <script src="<?= base_url(); ?>template/front-end//assets/js/jquery.easeScroll.js"></script>
