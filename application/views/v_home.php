            ...
            <div class="row" data-aos="fade-up">
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="position-relative">
                  <img
                    src="<?= base_url(); ?>template/front-end/assets/images/dashboard/banner.jpg"
                    alt="banner"
                    class="img-fluid"
                  />
                ...
                <div class="card bg-dark text-white">
                  <div class="card-body">
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="<?= base_url(); ?>template/front-end/assets/images/dashboard/home_2.jpg"
                          alt="thumb"
                          class="img-fluid img-lg"
                        />
                      </div>
                    ...
                    >
                      ...
                      <div class="rotate-img">
                        <img
                          src="<?= base_url(); ?>template/front-end/assets/images/dashboard/home_3.jpg"
                          alt="thumb"
                          class="img-fluid img-lg"
                        />
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4 grid-margin">
                        <div class="position-relative">
                          <div class="rotate-img">
                            <img
                              src="<?= base_url(); ?>template/front-end/assets/images/dashboard/home_4.jpg"
                              alt="thumb"
                              class="img-fluid"
                            />
                          </div>
